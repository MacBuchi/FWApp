...
(IconData, Color) equipmentCategoryStyle(
  EquipmentFunction? function,
) => switch (function) {
  EquipmentFunction.rettung => (Icons.medical_services, Colors.red),
  EquipmentFunction.brand => (Icons.local_fire_department, Colors.deepOrange),
...
extension on Color {
  ...
  Color get shade700OrSelf =>
      this is MaterialColor ? (this as MaterialColor).shade700 : this;
  Color get shade300OrSelf =>
