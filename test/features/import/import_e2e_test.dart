...
void main() {
  ...
  Future<EquipmentMatcher> createMatcher() async {
    ...
    final aliasesRaw =
        await File('assets/equipment_library/aliases.json').readAsString();
  ...
  test(
    'example HLF20 CSV: mapping detected, ≥95% matched, import applies',
    () async {
      ...
      final result = await service.apply(rows: rows, decisions: decisions);
