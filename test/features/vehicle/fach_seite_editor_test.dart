...
void main() {
  ...
  testWidgets('die Liste nennt die Verortung jedes Fachs', (tester) async {
    ...
    expect(
      find.textContaining('Fahrerseite · vorne · Reihenfolge 1'),
      findsOneWidget,
    );
  ...
  testWidgets('eine von Hand gewählte Seite überlebt weitere Tipper', (
    ...
    expect(
      gespeichert.single.laengsposition,
      isNull,
  ...
  group('der Vorschlag für den Bestand', () {
    testWidgets('erscheint nur, wenn es etwas vorzuschlagen gibt', (
      ...
      await oeffne(tester);
      expect(
        find.byTooltip('Verortung aus den Namen vorschlagen'),
        findsNothing,
      );
      await endTestApp(tester);
    });
    ...
    testWidgets('wer der Nummern-Konvention widersprochen hat, bekommt keinen '
