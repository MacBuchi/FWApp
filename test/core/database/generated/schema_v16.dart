...
class AbgeschalteteLernbereiche extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  AbgeschalteteLernbereiche(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  AbgeschalteteLernbereiche createAlias(String alias) {
    return AbgeschalteteLernbereiche(attachedDatabase, alias);
  }
...
class Fragenhinweise extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  Fragenhinweise(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> erledigtAm = GeneratedColumn<int>(
    'erledigt_am',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  @override
  Fragenhinweise createAlias(String alias) {
    return Fragenhinweise(attachedDatabase, alias);
  }
...
class EquipmentTags extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  EquipmentTags(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> kind = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT \'qr\'',
    defaultValue: const CustomExpression('\'qr\''),
  );
  late final GeneratedColumn<int> selfIssued = GeneratedColumn<int>(
    'self_issued',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (self_issued IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  late final GeneratedColumn<int> createdAt = GeneratedColumn<int>(
    'created_at',
  ...
  late final GeneratedColumn<int> dirty = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (dirty IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
  ...
  @override
  EquipmentTags createAlias(String alias) {
    return EquipmentTags(attachedDatabase, alias);
  }
...
class DatabaseAtV16 extends GeneratedDatabase {
  ...
  late final AbgeschalteteLernbereiche abgeschalteteLernbereiche =
      AbgeschalteteLernbereiche(this);
  late final Fragenhinweise fragenhinweise = Fragenhinweise(this);
  late final EquipmentTags equipmentTags = EquipmentTags(this);
  @override
